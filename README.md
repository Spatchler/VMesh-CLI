...
Options:
  ...
  -l, --subdivision-level arg (=0)    set depth to generate initial subtrees before combining for out 
                                      of core generation 
  ...
  --tribox                            use triangle box intersections instead of DDA voxelization, it 
                                      tends to be faster on low resolutions(<512) however it only generates 
                                      binary data 
